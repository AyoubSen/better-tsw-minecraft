...
export const CATEGORIES: Record<Category, CategoryMeta> = {
	...
	combat: {
		...
		emoji: "⚔️",
		description:
			"New enchantments, accessories, armour tiers and fighting mechanics",
	},
	decoration: {
	...
	library: {
		...
		emoji: "🔧",
		description:
			"Behind-the-scenes dependencies — you don't interact with these directly",
	},
};
...
export const MODS: Mod[] = [
	...
	},
	{
		...
		isLibrary: true,
		description:
			"Adds search functionality used by Controlling and other mods.",
		features: [],
	...
	},
	{
		...
		isLibrary: true,
		description:
			"Shared core for Sophisticated Backpacks and Sophisticated Storage.",
		features: [],
	...
	},
	{
		...
		isLibrary: true,
		description:
			"Performance profiler for diagnosing server lag. Used by server admins.",
		features: [],
		modrinth: "spark",
	},
];
