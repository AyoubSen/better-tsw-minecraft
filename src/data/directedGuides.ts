...
export const MOD_GUIDES: ModGuide[] = [
	// ── Travel ────────────────────────────────────────────────────────────────────
	{
		...
		category: "Travel",
		tagline:
			"Build a fast-travel network between your most important locations.",
		priority: "Essential",
	...
	},
	{
		...
		category: "Travel",
		tagline:
			"Real-time map, minimap, and waypoints so you never lose your base again.",
		priority: "Essential",
		searchTerms: [
			"map",
			"minimap",
	...
	},
	{
		...
		category: "Travel",
		tagline:
			"Point to any structure or biome — no more hour-long blind searches.",
		priority: "Useful",
		searchTerms: [
			"structure finder",
			"biome finder",
	...
	// ── Information ───────────────────────────────────────────────────────────────
	{
		...
		tagline:
			"Look up any recipe, use, enchant option, or loot source — always open in your inventory.",
		priority: "Essential",
		searchTerms: [
			"recipes",
			"uses",
	...
	},
	{
		...
		category: "Information",
		tagline:
			"Hover over anything in the world to see what it is and what state it is in.",
		priority: "Essential",
		searchTerms: [
			"tooltip",
			"overlay",
	...
	},
	{
		...
		category: "Information",
		tagline:
			"See exactly how much hunger and saturation food will restore before you eat it.",
		priority: "Useful",
		searchTerms: [
			"food",
			"hunger",
	...
	// ── Storage ───────────────────────────────────────────────────────────────────
	{
		...
		category: "Storage",
		tagline:
			"Wearable, upgradeable backpack that solves inventory pressure in the field.",
		priority: "Essential",
		searchTerms: [
			"backpack",
			"inventory",
	...
	},
	{
		...
		category: "Storage",
		tagline:
			"Larger, upgradeable storage chests with filtering and automation support.",
		priority: "Useful",
		searchTerms: [
			"chest",
			"storage",
	...
	},
	{
		...
		category: "Storage",
		tagline:
			"One terminal that searches and accesses everything in your connected chest network.",
		priority: "Useful",
		searchTerms: [
			"storage network",
			"terminal",
	...
	},
	{
		...
		category: "Storage",
		tagline:
			"Void unwanted items cleanly instead of letting junk overflow your storage.",
		priority: "Useful",
	...
	},
	{
		...
		category: "Combat",
		tagline:
			"Treasure-drop utility items that give passive mobility, survivability, and convenience bonuses.",
		priority: "Useful",
		searchTerms: [
			"artifacts",
			"treasure",
	...
	},
	{
		...
		category: "Combat",
		tagline:
			"Extra equipment slots for rings, charms, and artifact items beyond your armor.",
		priority: "Useful",
		searchTerms: [
			"accessories",
			"trinkets",
	...
	},
	{
		...
		category: "Gear",
		tagline:
			"Enchanting and repair are much friendlier here — use the tools this pack gives you.",
		priority: "Useful",
		searchTerms: [
			"enchanting",
			"anvil",
	...
	},
	{
		...
		category: "Gear",
		tagline:
			"Gear progression extends well past vanilla Netherite — there are higher tiers.",
		priority: "Useful",
		searchTerms: [
			"mythic",
			"netherite",
	...
	// ── Survival ──────────────────────────────────────────────────────────────────
	{
		...
		category: "Survival",
		tagline:
			"A gravestone spawns when you die — your items are safe until you recover them.",
		priority: "Essential",
		searchTerms: [
			"grave",
			"death",
	...
	},
	{
		...
		category: "Survival",
		tagline:
			"Sleeping bags and hammocks let you sleep without setting a new spawn point.",
		priority: "Useful",
		searchTerms: [
			"sleeping bag",
			"hammock",
	...
	},
	{
		...
		category: "Survival",
		tagline:
			"Structure chests are personal — everyone on the server gets their own loot.",
		priority: "Useful",
		searchTerms: [
			"loot",
			"chest",
	...
	// ── World & Exploration ───────────────────────────────────────────────────────
	{
		...
		tagline:
			"The overworld is dramatically larger and more varied than vanilla — explore with a plan.",
		priority: "Useful",
		searchTerms: [
			"worldgen",
			"biomes",
	...
	},
	{
		...
		category: "Exploration",
		tagline:
			"All three dimensions are fully overhauled — treat each one like a destination, not a checklist.",
		priority: "Useful",
		searchTerms: [
			"aether",
			"nether",
	...
	},
	{
		...
		category: "Exploration",
		tagline:
			"Structures are bigger, harder, and more rewarding — prepare before going in.",
		priority: "Useful",
		searchTerms: [
			"dungeon",
			"stronghold",
	...
	// ── Building ──────────────────────────────────────────────────────────────────
	{
		...
		category: "Building",
		tagline:
			"A deep decoration stack that makes bases easier to use, not just prettier.",
		priority: "Niche",
		searchTerms: [
			"building",
			"decoration",
	...
	},
	{
		...
		category: "Building",
		tagline:
			"Functional decoration — signs, displays, ropes, jars, and many small utility blocks.",
		priority: "Niche",
		searchTerms: [
			"supplementaries",
			"sign",
	...
	// ── Mobs & Villagers ──────────────────────────────────────────────────────────
	{
		...
		category: "Mobs",
		tagline:
			"Trading and mob interactions are smoother and less grind-heavy than vanilla.",
		priority: "Useful",
		searchTerms: [
			"villagers",
			"trading",
	...
	// ── Technology ────────────────────────────────────────────────────────────────
	{
		...
		category: "Technology",
		tagline:
			"Full automation and machine processing when manual workflows stop being enough.",
		priority: "Niche",
		searchTerms: [
			"oritech",
			"machines",
	...
	// ── Creative ──────────────────────────────────────────────────────────────────
	{
		...
		category: "Creative",
		tagline:
			"In-game photography with film, development, and printable photos.",
		priority: "Niche",
		searchTerms: [
			"camera",
			"photo",
...
for (const guide of MOD_GUIDES) {
	for (const modName of guide.mods) {
		if (!PLAYER_MOD_NAMES.has(modName)) {
			throw new Error(
				`Mod guide "${guide.id}" references unknown mod "${modName}"`,
			);
		}
	}
}
