    ...
    <>
      ...
      >
        ...
        <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          ...
          {/* Description */}
          <p style={{ margin: 0, fontSize: '0.875rem', color: 'var(--text-soft)', lineHeight: 1.7 }}>
            {mod.description}
          </p>
          ...
          {mod.features.length > 0 && (
            <section>
              <p className="label" style={{ marginBottom: '0.875rem' }}>What it adds</p>
              <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                {mod.features.map((feat) => (
                  <li
                    key={feat}
                    style={{ display: 'flex', alignItems: 'flex-start', gap: '0.6rem', fontSize: '0.83rem', color: 'var(--text-soft)' }}
                  >
                    <span
                      style={{
          ...
          {(mod.modrinth || mod.curseforge) && (
            <section>
              <p className="label" style={{ marginBottom: '0.875rem' }}>Learn more</p>
